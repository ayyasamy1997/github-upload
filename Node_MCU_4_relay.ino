...
const char* ssid = "ayyasamy"; // Input your wifi network name
...
const int relay1 = 5; // GPIO5 D1 fan
const int relay2 = 4; // GPIO4 D2 led
const int relay3 = 0; // GPIO0 D3 motor
const int relay4 = 2; // GPIO2 D4 whther motor
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println("<p>fan 1 - State " + relay1State + "</p>");
